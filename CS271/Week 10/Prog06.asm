TITLE Programming Assignment #5 Low Level I/O    (Project05A_S.asm)

; Author:									Jonathan Nicolosi
; OSU Email:								nicolosj@oregonstate.edu
; Course-Section:							CS271-400
; Assignment Number :						05A
; Date:										08/07/16
; Due Date:									08/07/16
; Description:
...
welcome					   BYTE	  "Welcome to Low Level I/O by Jonathan Nicolosi.", 0
...
enteredString			   BYTE   "The numbers entered were: ", 0
